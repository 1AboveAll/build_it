...
public class MainActivity extends AppCompatActivity {
    ...
    public final static String TAG="IsTagged";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleLoginButton=findViewById(R.id.main_activity_google_sign_in_button);
    ...
    public void updateUI(FirebaseUser user){
        ...
        if(user!=null){
            ...
            database.child("users").orderByChild("email").equalTo(user.getEmail()).limitToFirst(1).addValueEventListener(userProfileEventListener);
                ...
                for(DataSnapshot child:dataSnapshot.getChildren()){
                    ...
                    database.child("users").child(key).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(existingUser.getUserType().equals("labourer")){
                                Intent i= new Intent(MainActivity.this, Labourer.class);
                                startActivity(i);
                                Log.i("Hey","Labour");
                            }else
                            if(existingUser.getUserType().equals("contractor")){
                                Intent i= new Intent(MainActivity.this,Contractor.class);
                                startActivity(i);
                            }else
                            if(existingUser.getUserType().equals("stakeholder")){

                                Intent i= new Intent(MainActivity.this, Stakeholder.class);
                                startActivity(i);
                                Log.i("Hey","Labour");
